...
public interface TestInterface extends ParentTestInterface{
	...
	/**
	 * This method provides default implementation and default methods cannot be final and also cannot have synchronized modifier
	 */
	public default void defaultTestMethod() {
		// You cannot access Parent interface default implementation from a child interface using super
